    ...
    <div className={`flex flex-col justify-between bg-[#212327] pt-7 transition-all z-50 max-md:absolute max-md:h-screen ${expand ? 'p-4 w-64' : 'md:w-20 w-0 max-md:overflow-hidden'}`}>
        <div>
            ...
            <button className={`mt-8 flex items-center justify-center cursor-pointer ${expand ? "bg-primary hover:opacity-90 rounded-2xl gap-2 p-2.5 w-max" : 
                ...
                transition bg-black text-white text-sm px-3 
        ...
        <div>
            ...
            className={`flex items-center ${expand ? 'hover:bg-white/10 round-lg' : 'justify-center w-full'} gap-3 text-white/60 text-sm p-2 
            mt-2 cursor-pointer`}>  
